            ...
            <div className="leave-page" style={{ backgroundImage: 'url(images/leave-bg.svg)' }}>
                <div className="leave-page_content row medium-7 large-7">
                    <div className="column">
                        <h4>
                            Вы покидаете <a href="https://golos.id/" target="_blank">Golos.id</a>
                        </h4>
                        <p>
                            Вы кликнули на ссылку, ведущую на внешний ресурс, и покидаете блог-платформу <a href="https://golos.id/" target="_blank">Golos.id</a>.
                        </p>
                        <p>
                            Ссылка, на которую вы кликнули, переведет вас по адресу: <strong>{targetPage}</strong></p>
                        <p>
                            <a href="https://golos.id/" target="_blank">Golos.id</a> не имеет никакого отношения к сайту, расположенному по ссылке выше, и не может гарантировать вам безопасность его использования. Сайты с закрытым исходным кодом могут содержать вредоносные скрипты и использовать мошеннические схемы.
                        </p>
                        <p>

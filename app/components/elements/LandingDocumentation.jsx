		...
		return (
			<section className="Documentation" id="docs">
				...
				<div className="row Documentation__buttons">
					<div className="small-12 columns">
						<a href="https://golos.id/ru--golos/@golos/golos-russkoyazychnaya-socialno-mediinaya-blokchein-platforma" target="blank" className="button alert">Детали про Голос</a>
						<a href="https://wiki.golos.id/1-introduction/steem_whitepaper.html" target="blank" className="button">Детали про Стим</a>
					</div>
				</div>
				<hr />
			</section>

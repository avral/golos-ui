	...
	render() {
      ...
      'Китовый сонар',
		...
		const secondaryTexts = [
			...
			'Получайте уведомления обо всех действиях с Вашими постами и комментариями на golos.id. GolosNotify позволяет Вам получать оповещения о различных действиях с Вашими постами.',
